...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("config_screen", "为了能够远程访问你的桌面, 请给予 RustDesk \"开始输入\" 权限。"),
        ("Installing ...", "安装中..."),
        ("Install", "安装"),
        ("Installation", "安装"),
        ...
        ("How to get Android input permission?", "如何获取安卓的录音权限？"),
        ("android_input_permission_tip1", ""),
        ("android_input_permission_tip2", "正在设置录音权限！"),
        ...
        ("android_start_service_tip", "点击开始服务或启动服务时 获取录音权限 即可开始录音"),
        ...
        ("Start on boot", "开机自启动"),
        ("Start the screen sharing service on boot, requires special permissions", "开机自动启动[建议开启]"),
