          ...
          if (resp.access_token != null) {
            try {
              ...
              if (resp.user != null) {
                ...
                String? validationError = await gFFI.userModel.validateUser(resp.user!);
            ...
            if (storeIfAccessToken) {
              ...
              if (resp.user != null) {
                gFFI.userModel.parseAndUpdateUser(resp.user!);

                ConnectionPage.updateExpiryInfo(context);
              }
            if (close != null) {
              close(true);
            }
                    ...
                    try {
                      ...
                      if (resp.user != null) {
                        ...
                        if (validationError != null) {
                          ...
                          BotToast.showText(contentColor: Colors.red, text: errorMsg);
                          return;
                        }
                      }
                    } catch (e) {
...
void logOutConfirmDialog() {
  gFFI.dialogManager.show((setState, close, context) {
    submit() async {
      ...
      await gFFI.userModel.clearExpiryInfo();
