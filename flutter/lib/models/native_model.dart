...
typedef set_login_username_func = Void Function(Pointer<Int8>);
typedef SetLoginUsername = void Function(Pointer<Int8>);
...
class PlatformFFI {
  ...
  late SetLoginUsername _setLoginUsername;

  void setLoginUsername(String username) {
    final usernamePtr = username.toNativeUtf8();
    _setLoginUsername(usernamePtr.cast<Int8>());
  ...
  Future<void> init(String appType) async {
    ...
    try {
      ...
      _setLoginUsername = dylib
          .lookup<NativeFunction<set_login_username_func>>('set_login_username')
          .asFunction();
      try {
        // SYSTEM user failed
