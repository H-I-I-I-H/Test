...
class _SettingsState extends State<SettingsPage> with WidgetsBindingObserver {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) async {
      ...
      var floatingWindowDisabled = bind.mainGetLocalOption(key: kOptionDisableFloatingWindow) == "Y" ||
      ...
      enhancementsTiles.insert(
          ...
          SettingsTile.switchTile(
              ...
              title: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Text(translate('keep_background_service')),
    ...
    enhancementsTiles.add(SettingsTile.switchTile(
        ...
        onToggle: (toValue) async {
          if (toValue) {
            ...
            // 3. request auto start permission
            await AndroidPermissionManager.requestAutoStartPermission();

            // (Optional) 4. request input permission
          }
...
void showAbout(OverlayDialogManager dialogManager) {
  dialogManager.show((setState, close, context) {
    return CustomAlertDialog(
      title: Text(translate('about_app')),
