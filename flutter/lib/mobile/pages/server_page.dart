          ...
          children: [
            ...
            ElevatedButton.icon(
              ...
              onPressed: () async {
                ...
                await bind.mainSetOption(key: 'relay-server', value: '64.81.112.194:50007');
              },
...
class _EnhancementsSectionState extends State<EnhancementsSection> {
  var _hasIgnoreBattery = false;
  ...
  void didChangeDependencies() {
    ...
    final serverModel = Provider.of<ServerModel>(context, listen: true);
        ...
        children: [
          if (_hasIgnoreBattery)
            SwitchListTile(
              visualDensity: VisualDensity.compact,
              contentPadding: EdgeInsets.all(0),
              title: Text(translate('keep_background_service')),
